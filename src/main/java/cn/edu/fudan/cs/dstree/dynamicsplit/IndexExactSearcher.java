...
public class IndexExactSearcher {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        String searchFileName = "data/Series_64_20000.z.txt";
        if (args.length >= 1)
            searchFileName = args[0];

        System.out.println("searchFileName = " + searchFileName);

        String indexPath = "data/Series_64_20000.z.txt.idx_dyn_100_1";
...
//        newRoot.printTreeInfo();
    ...
    public static Node exactSearch(double[] queryTs, Node root) throws IOException {
        ...
        bsfAnswer.dist = DistUtil.minDistBinary(approxNode.getFileName(), queryTs);//binary
        bsfAnswer.Ts = DistUtil.minDistTsBinary(approxNode.getFileName(), queryTs);
...
//                double[][] tss = TimeSeriesFileUtil.readSeriesFromFile(fileName);
                ...
                //minPqItem.Ts = DistUtil.minDistTs(tss, queryTs);
